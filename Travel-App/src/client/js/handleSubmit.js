...
const WeatherApiKey="b801bd391df5d71efffab7de86165df";
...
const pixabayKey="33233998-fce9fd05ccb5a5c94d9d60234";
...
function handleSubmit(e){
    ...
    const url=`${geoNameURL}${toPlace}&maxRows=10&username=travel`;
